...
const I18N = {
  fr: {
    ...
    "cap.intro": "La certification RNCP 39774 — Expert en architecture informatique — est la finalité de ma formation. Elle correspond à un niveau bac +5, et c’est un bon argument pour montrer que je m’inscris dans un cursus structuré, orienté architecture, data et déploiement.",
    "cap.badge": "Cursus de spécialisation",
    "cap.feature.h": "La finalité de ma formation",
    "cap.feature.p": "Le lien vers la certification est ici : je vise le RNCP 39774 comme aboutissement de ma formation, avec une vraie logique bac +5 autour de l’architecture, de la data et de l’intégration.",
